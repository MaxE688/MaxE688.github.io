// node_modules/jquery-breakpoints/jquery.breakpoints.js
(function($) {
  var Breakpoints = function(el, options) {
    ...
    if ($.isFunction($(window).on)) {
      $(window).on("resize." + _.n, function(e) {
        ...
        resizeThresholdTimerId = setTimeout(function(e2) {
          _resizeCallback();
          _compareTrigger();
        }, _.settings.buffer);
      });
...
jquery-breakpoints/jquery.breakpoints.js:
  (*
   * @license jQuery Breakpoints | MIT | Jerry Low | https://www.github.com/jerrylow/breakpoints
   *)
*/
//# sourceMappingURL=jquery-breakpoints.js.map
